...
const Telemedicine = () => {
  ...
  const categories = [
    { name: "General Surgeon", icon: "/profilePic.jpg" },
    { name: "Obstetrics & Gynecology", icon: "/profilePic.jpg" },
    { name: "Neuro Surgeon", icon: "/profilePic.jpg" },
    { name: "Pediatric Surgeon", icon: "/profilePic.jpg" },
  ];
        ...
        {filteredDoctors.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
            {filteredDoctors.map((doctor, index) => (
              <Link key={index} href="/telemedicine">
